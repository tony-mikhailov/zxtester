...
Идея проекта взята в проекте NanoLogic <https://github.com/vnesebya/nanologic.git> - простого логического пробника с функцией отрисовки форм сигнала похожей на осцилограмму
